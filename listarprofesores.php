        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/admin/1.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Modificar jefes de sección</h2>
              </div>
            </div>
          </div>
        </div>
...
<table class="todo">
    ...
    <table style="margin: auto; width: 800px; border-collapse: separate; border-spacing: 10px 5px">
        <thead>
        <th>CORREO</th>
        <th>NOMBRE JEFE SECCIÓN</th>
        <th>SECCIÓN</th>
        <th> <a href="profesor_new1.php"> 
    ...
    <?php
        ...
        $resultado = $conexion->query($query) or die ("Error jefe de seccion: ".mysqli_error($con));
        ...
        ?>
            <tr>
                ...
                <td><a href="modificarprofesores.php?usr=<?php echo $filas['correo'] ?> "> 
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                    </svg>
            </a> </td>
                <td><a href="profesores_delete.php?usr=<?php echo $filas['correo'] ?> "> 
