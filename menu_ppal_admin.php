...
//echo "Bienvenido, administrador. Estás en el menú principal";
include("sesion.php");
if($_SESSION["tipo_usuario"] == "Administrador"){
    ...
    <head>
        ...
        <link href="assets/css/menu-ppal-style.css" rel="stylesheet">
                ...
                <div class="col-xl-11 d-flex align-items-center">
                    ...
                    <nav class="nav-menu d-none d-lg-block">
                        <ul>
                            ...
                            <li><a href="#portfolio">Administración</a></li>
        ...
        <div class="intro-container">
            <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active" style="background-image: url(assets/img/intro-carousel/1.jpg);background-position: bottom;">
    ...
    <section id="portfolio" class="section-bg">
            ...
            <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <a href="listarsecciones.php">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <h4><a href="listarsecciones.php">Secciones</a></h4>
                        </div>
                    </div>
                  </a>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-arte">
                  <a href="listarprofesores.php">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <h4><a href="listarprofesores.php">Jefes</a></h4>
                        </div>
                    </div>
                  </a>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-arte">
                  <a href="listaruniversidades.php">
                    <div class="portfolio-wrap">
                        <figure>
                        ...
                        <div class="portfolio-info">
                            <h4><a href="listaruniversidades.php">Universidades</a></h4>
                        </div>
                    </div>
                  </a>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-aca">
                  <a href="main/Usuarios/users.php">
                    <div class="portfolio-wrap">
                        <figure>
                        ...
                        <div class="portfolio-info">
                            <h4><a href="main/Usuarios/users.php">Usuarios</a></h4>
                        </div>
                    </div>
                  </a>
                </div>
