...
<body>
  ...
  <section id="intro">
    ...
    <div id="contenido" style="margin:auto;width: 800px; border-collapse: separate;border-spacing: 10px 5px;">
        <span> <h1>Nueva Sección:</h1></span>
        <br>

        <form action="seccion_new2.php" method="POST" style="border-collapse: separate; border-spacing: 10px 5px;">
            <div class="row col-xs-3">
                <label>Código sección</label>
                <input type="mail" name="codigo" id="correo" class="form-control" >
            </div>
            <div class="row col-xs-3">
            ...
            <div class="row col-xs-3">
                ...
                <input type="text" name="descripcion" id="apellido" class="form-control">
            </div>
            <br>
